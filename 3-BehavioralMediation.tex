...
Association rates exclusive of consortship associations are likely to be correlated with consortship associations, %since part of what defines an alliance as such is the association among individuals, and males tend to participate in consortships with second-order allies, 
...
%Engaging in SAC has a positive effect on relationships. 
%Two ways of measuring relationships: dyadic association index and dyadic consortship index
%These two indices have been shown to be correlated (connor WC study)
%
%Its not just the simple fact of association that matters, but what you do together that ultimately affects the relationship.
%SAC is a better predictor of a critical relationship index, dyadic consortship index, than the simple fact of association. 
%
%what affects relationships is not just the simple fact of association, but what individuals do when they're together, I test the hypothesis that SAC predicts consortship association better than association rate.
%
%I test the prediction that males who are most successful (have the highest individual consortship rates) also engage in the highest rates of SAC. I also examine the relationship between how often a dyad associates together (their association index) and how often they consort together (their consortship index), and test whether males who have the highest association and dyadic consortship indices also engage in the highest rates of social coordination. Finally, I test the prediction that fusion events are accompanied by higher rates of SAC and social vocalizations than after five or more minutes of association among third-order allies. The list of hypotheses below build on each other consecutively to address these predictions.
...
\vspace{2mm}
%& Finally, I draw on the the analyses conducted this section to describe the \emph{cognitive complexity} exhibited by the male alliance network in terms of the range of interactions observed, the context and embeddedness of their production, the process of interactions, and how such processes relate to the structure and dynamics of the web of relationships exhibited by the alliance network. % CHAPTER 4!
\end{easylist}
...
\begin{figure}
  \centering
    \includegraphics[width=1\textwidth]{Ch3_Questions}
  \caption{Ch.3 Questions and hypotheses summarized} % elaborate
  \label{fig:questions}
\end{figure}
...
\begin{figure}
  ...
  \caption{Focal scan data collected in 2012. See in-text description.} % elaborate
...
\begin{figure}
  \centering
    \includegraphics[width=.5\textwidth]{behaviorCategories}
  \caption{} % elaborate
  \label{fig:behaviors}
\end{figure}
...
\clearpage
\includepdf[pages=-]{Ethogram.pdf}
\includepdf[pages=-]{AcousticCodes.pdf}
